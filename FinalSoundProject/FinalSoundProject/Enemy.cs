...
namespace FinalSoundProject
{
    public class Enemy : Player
    {
        ...
        #endregion
        public Enemy(Game game, Texture2D PlyerText, Point size, Vector2 position,
            Camera cam, Dictionary<GameLibrary.Moves, Vector3> movs, GameLibrary.Moves initMv, int offset, float speed,
            Rectangle activeArea, float energy)
            : base(game, PlyerText, size, position, cam, movs, initMv, offset, speed, energy)
        {
