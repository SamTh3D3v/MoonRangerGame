...
namespace FinalSoundProject.Screens
{
    ...
    public class MainScreen : GameStateBase
    {
        ...
        protected override void LoadContent()
        {
            ...
            Krypton.Initialize();
            Dictionary<Moves, Vector3> mainPlayerMoves = new Dictionary<Moves, Vector3>()
                                                {
            ...
            mainPlayer = new Player(GameRef, Content.Load<Texture2D>(@"Assets\Images\SmallPlayer"),
                new Point(50, 50), StartEndPositions.First().First() * TileSize, camera, mainPlayerMoves, Moves.Left, 15, 5);
