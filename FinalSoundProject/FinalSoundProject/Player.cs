...
namespace FinalSoundProject
{
    public class Player : DrawableGameComponent
    {
        ...
        #endregion
        #region Methods
        public Player(Game game, Texture2D PlyerText, Point size, Vector2 position, Camera cam, Dictionary<Moves, Vector3> _movs, Moves initMov, int offset, float speed, float energy = DefaultEnergyValue)
            : base(game)
        {
            _gameRef = (Game1)game;
            _camera = cam;
